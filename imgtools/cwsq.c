...
void CWSQ_procargs(int, char **, float *, char **, char **, int *,
...
int CWSQ_main(int argc, char *argv[])
{
   int ret;
   char *outext;
   ...
   CWSQ_procargs(argc, argv, &r_bitrate, &outext, &ifile, &rawflag,
...
//.B % cwsq .75 wsq finger.raw -r 500,500,8,500
/*****************************************************************/
void CWSQ_procargs(int argc, char **argv, float *r_bitrate,
