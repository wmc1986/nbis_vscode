...
void DWSQ_procargs(int , char **, char **, char **, int *);
...
int DWSQ_main(int argc, char **argv)
{
   int ret;
   ...
   DWSQ_procargs(argc, argv, &outext, &ifile, &rawflag);
...
/*****************************************************************/
void DWSQ_procargs(int argc, char **argv, char **outext, char **ifile, int *rawflag)
{
