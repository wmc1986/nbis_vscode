...
void AN2K2IAF_procargs(int, char **, char **, char **);

/*************************************************************************
**************************************************************************/
int AN2K2IAF_main(int argc, char *argv[])
{
   char *ifile, *ofile;
   int ret;
   ANSI_NIST *ansi_nist;
   ...
   AN2K2IAF_procargs(argc, argv, &ifile, &ofile);
...
**************************************************************************/
void AN2K2IAF_procargs(int argc, char **argv, char **ifile, char **ofile)
{
